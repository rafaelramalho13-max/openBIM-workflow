...
with tab4:
    ...
    bep_excel_path = "requisitos/Anexo_BEP.xlsx"
    if os.path.exists(bep_excel_path):
        ...
        st.warning("O arquivo Anexo_BEP.xlsx não foi gerado ainda. Execute o script `requisitos/gerar_anexo_bep.py` para criá-lo.")
        
    st.markdown("---")
    
    # Embed and render PIR.md inside Streamlit
    pir_path = "requisitos/PIR.md"
